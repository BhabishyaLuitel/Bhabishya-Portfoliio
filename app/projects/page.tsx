...
export function BentoGridThirdDemo() {
	return (
        ...
        <Navigation />
        <div className="mt-16 ">
		<BentoGrid className="max-w-4xl p-3 mx-auto md:auto-rows-[20rem]">
			{items.map((item, i) => (
				<BentoGridItem
					key={i}
					title={item.title}
...
const SkeletonFive = () => {
	...
	return (
				...
				<motion.div
					initial="initial"
					whileHover="animate"
					className="flex mt-8 items-center flex-1 w-full h-full min-h-[6rem] dark:bg-dot-white/[0.2] bg-dot-black/[0.2] flex-col space-y-2">
					<motion.div
						variants={variants}
